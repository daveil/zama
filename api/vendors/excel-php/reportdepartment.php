...
if(isset($_POST['export']))
  ...
  $department=mysql_real_escape_string($_POST['department']);
		...
		$filename = "$department Accountability"; //your file name
		...
		*/
		$objPHPExcel->getActiveSheet()->setCellValue('A1', 'Accountability of Employees Per Department');		
		$objPHPExcel->getActiveSheet()->setCellValue('A2', '('.$department.' Department)');
...
$sql="SELECT a.id, a.emp_no, e.lastname, e.firstname, e.middlename, e.position, e.date_hired, a.category, a.item FROM tblgaaccountability a INNER JOIN tblemployees e ON a.emp_no = e.emp_no WHERE a.emp_no IN (Select emp_no from tblemployees where department = '$department')";
$qry=mysql_query($sql);		
