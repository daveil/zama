<div class="departments index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $department['Department']['code'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $department['Department']['code'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $department['Department']['code']), null, sprintf(__('Are you sure you want to delete # %s?', true), $department['Department']['code'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
