<div class="kpis index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $kpi['Kpi']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $kpi['Kpi']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $kpi['Kpi']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $kpi['Kpi']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
