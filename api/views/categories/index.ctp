<div class="categories index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $category['Category']['code'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $category['Category']['code'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $category['Category']['code']), null, sprintf(__('Are you sure you want to delete # %s?', true), $category['Category']['code'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
